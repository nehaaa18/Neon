...
<html lang="en">
<head>
    <title>Sign In</title><link href="https://fonts.googleapis.com/css2?family=Lemonada:wght@300;500&family=Recursive:wght@300;400;500;600;700;800;900&display=swap" rel="stylesheet">
    ...
    function validate()
	{
		...
		if (passwordValue <=4 || passwordValue>=10)
		{
   ...
   <div class="navbar">
    ...
    <nav>
        <ul>
            ...
            <li><a href="../html/signup.html.html">Sign Up</a></li>
...
<div class="page-wrapper">
    ...
    <div id="login-box">
        <div class="left-box">
            <form id="form" name="f2" class="form"  action="2.php" method="post">
                <h1> Sign Up</h1>
            ...
            <br>
                ...
                <button id="submit" onclick="return validate();" name="submit">Submit</button>
                <!-- <br> -->
            </form>
        <!-- <br> -->
        </div>
...
<?php
/*connecting to database in xampp*/
...
if(isset($_POST['submit']))
{
	...
	/* writing the query for inserting data in database */
	
  $str = "insert into user set name='$name',email='$email',password='$pass',password_rep='$password2'";
